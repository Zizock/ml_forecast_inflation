# ==========================================================
# Lasso model for time series forecasting
# ==========================================================
...
# tune and train a Lasso model with data from the start to (end - TEST_SIZE - h),
...
# MODEL_NAME: LASSO
# RESULT_ROOT: results shared folder path / LASSO
...
def add_lag_and_rolling_features(data, max_lag):
    """
    Args:
...
def expanding_window_backtest(
    ...
    test_data,
    X_columns,
    Y_column, # also can be list if needed
    ):
    """
